...
RESPONSES = {
    ...
    'shit': [
   	 'Oh, a fresh creation... truly a sight to behold. You\'re building quite the legacy.',
   	 'Here we go again, another display of your... unmistakable style. Should we prepare for a showcase?',
   	 'Every day, a new "contribution" from you. Consistency is key!',
   	 'Your passion for sharing these moments is... something to be admired.',
   	 'Is this a new one? Your... creative streak is undeniable.',
   	 'With every piece, you\'re really... exploring new boundaries.',
   	 'Back with another showstopper? Your... collection is certainly unique.',
   	 'Is this your latest... exhibit? You\'ve got a knack for consistency.',
   	 'Ah, another... presentation. You\'re keeping us on our toes!',
   	 'Each day brings a new surprise. What... wonders will you share next?',
   	 'Your... contributions are nothing if not memorable.',
   	 'And here we have the latest... offering. It\'s... quite something.',
   	 'Is this today\'s... surprise? You never fail to astonish.',
   	 'With each masterpiece, you\'re really... finding your voice.',
   	 'Ah, a new... creation. Your dedication is truly... noteworthy.',
   	 'Is this your latest... work? You\'re on a roll!',
   	 'Back at it? Your... creativity knows no bounds.',
   	 'With this latest gem, you\'re really... making an impact.',
   	 'Oh, a new... piece. Your... artistry is on full display.',
   	 'Here\'s another... classic. Your consistency is... commendable.'
     ],
